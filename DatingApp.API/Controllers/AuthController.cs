...
namespace DatingApp.API.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public async Task<IActionResult> Register(UserForRegisterDto userForRegisterDto)
        {
            ...
            if (await this._repo.UserExits(userForRegisterDto.Username))
            {
            ...
            return StatusCode(201); // Just for testing purposes
        }
        ...
        public async Task<IActionResult> Login(UserForLoginDto userForLoginDto)
        {
            ...
            //Did this to send our info that can be used in different components (Could be UserForNavDto later on)
            var user = this._mapper.Map<UserForListsDto>(userFromRepo);
